...
##以下、初期設定項目の自動設定
@mailformENV = ('date','serial','input_time','conversion_count','pv','unique','conversion_rate','http_referer','sitein_referrer','host_name','ip_add','user_agent','confirm_time','iplogs','errorlog','http_referer');
@mailformENVname = ('POST DATE','SERIAL NUM','INPUT TIME','CONVERSION','PAGE VIEW','UNIQUE USERS','CONVERSION RATE','REFERRER','SITE IN REFERRER','HOST NAME','IP ADDRESS','USER AGENT','CONFIRM TIME','IP Page Traking','ERROR LOG','HTTP REFERER');
