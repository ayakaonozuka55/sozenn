...
## フォームの送信先
#push @mailto,'freedom10furukawa@gmail.com';
push @mailto,'a.gotanda@shozen.com';
...
$config{'ThanksPage'} = '../thanks.php';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] 株式会社ショーゼン 採用応募';
...
$config{"ReturnSubject"} = '[ %s ] 採用応募ありがとうございました';
