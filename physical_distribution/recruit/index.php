...
<body onload="initialize()" id="blue">
...
<div id="mainVisual">
<img src="../images/recruit/main_visual00.png" alt="採用情報" width="980" height="135" />
</div><!-- /mainVisual -->
...
<h2  class="greener" id="anc_track">トラック運転手募集</h2>
