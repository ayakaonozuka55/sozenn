...
$replace{'bus_type'} .= qq|<tr><td width="240">大型28人乗　≪正シート28席・補助ナシ≫ </td><td>$sid{'type7'}台</td><tr>\n| if( $sid{'type3'} );
$replace{'bus_type'} .= qq|<tr><td width="240">中型40人乗　≪正シート33席・補助7席≫ </td><td>$sid{'type3'}台</td><tr>\n| if( $sid{'type4'} );
$replace{'bus_type'} .= qq|<tr><td width="240">小型25人乗　≪正シート25席・補助ナシ≫</td><td>$sid{'type4'}台</td><tr>\n| if( $sid{'type5'} );
