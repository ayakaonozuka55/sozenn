...
<p class="l5 small">Email：<a href="mailto:webmaster@shozen.com">kanko-bus@shozen.com</a></p><br />
	</div>
	</div>
	<!-- /■■左のメニュー部分ここまで■■-->
	<!-- ■■ページ右部分ここから■■-->
	
	<div class="right"><div class="block">
	<!-- ■■カテゴリ名ここから■■-->
	<h3><img src="img/title.gif" alt="観光バス -団体貸切バス旅行プラン-" width="528" height="30"></h3>
	<!-- /■■カテゴリ名ここまで■■-->
	<!-- ■■右のコンテンツ部分ここから■■-->
	<img src="img/kouji.gif">
