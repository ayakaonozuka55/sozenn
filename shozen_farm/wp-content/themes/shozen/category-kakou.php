...
<div class="wrapper_widesub">
	<div class="pankuzu"><a href="<?php echo home_url(); ?>/"><i class="fa fa-home"> ホーム</i></a>　｜　加工場情報</div>
	<div class="subttl_area">
		<div class="subttl">
			<div class="subttl_txt ttl_oneline">加工場情報</div>
		</div>
	</div>
</div>
<!-- /.wrapper_wideall -->
...
<div class="wrapper">
	<section class="l-section">
		...
		<div class="newsttl">ショーゼンファームの加工場情報</div>
...
query_posts('posts_per_page=10&cat=3&paged='.$paged);
?>
<?php if ( have_posts() ) : ?>
