...
<div class="wrapper_widesub">
	<div class="pankuzu"><a href="<?php echo home_url(); ?>/"><i class="fa fa-home"> ホーム</i></a>　｜　農場情報</div>
	<div class="subttl_area">
		<div class="subttl">
			<div class="subttl_txt ttl_oneline">農場情報</div>
		</div>
	</div>
</div>
<!-- /.wrapper_wideall -->
...
<div class="wrapper">
	<section class="l-section">
		...
		<div class="newsttl">ショーゼンファームの農場情報</div>
