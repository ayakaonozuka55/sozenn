...
## フォームの送信先
push @mailto,'g-yasuhiro@shozen.com';

## 自動返信メールの差出人名
$config{'fromname'} = '株式会社ショーゼンファーム';
...
$config{'ThanksPage'} = 'http://www.shozen.com/shozen_farm/contact_thanks/?no=%s';
...
$config{"ReturnSubject"} = '[ %s ] お問い合わせありがとうございました';
