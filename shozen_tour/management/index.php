...
<title>運輸安全マネジメント | ショーゼン観光バス</title>
...
<div id="mainVisual">
<img src="../images/management/main_visual.png" alt="送迎バス" width="980" height="135" />
</div><!-- /mainVisual -->
...
<p><a href="../pdf/anzen_kihonhoushin.pdf" target="_blank">輸送の安全に関する基本的な方針</a></p>
<p><a href="../pdf/anzen_mokuhyou_tassei.pdf" target="_blank">輸送の安全に関する目標及び当該目標の達成状況</a></p>

<!--<p><a href="../pdf/test.pdf" target="_blank">自動車事故報告規則第2条に規定する事故に関する統計<br>（総件数及び類型別の事故件数）</a></p>-->

<!--
<p><a href="../pdf/test.pdf" target="_blank">輸送の安全に関する組織体制</a></p>
<p><a href="../pdf/test.pdf" target="_blank">緊急事態発生連絡網</a></p>
-->
